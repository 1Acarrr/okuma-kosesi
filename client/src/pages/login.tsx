...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-dark-bg-primary flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        {/* Logo/Title */}
        <div className="text-center mb-8 space-y-2">
          <h1 className="text-4xl font-serif font-bold text-warm-beige">Okuma Köşesi</h1>
          <p className="text-text-medium">Hoş geldiniz, okumaya devam.</p>
        </div>

        {/* Login Form */}
        <div className="glass border border-warm-beige/10 rounded-2xl p-8 shadow-soft-lg">
          <h2 className="text-2xl font-serif font-semibold text-warm-beige mb-6">Giriş Yap</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-text-medium">
              Hesabınız yok mu?{' '}
              <Link href="/register" className="text-warm-beige hover:text-warm-light underline decoration-warm-beige/50">
                Kayıt Olun
              </Link>
            </p>
          </div>
